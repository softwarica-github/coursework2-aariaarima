...
class Stegno:
    ...
    def main(self,root):
        root.title('Image Steganography by Garima Shrestha 220068')
        root.geometry('500x600')
        root.resizable(width =False, height=False)
        f = Frame(root)

        title = Label(f,text='\n\n\n• Image Steganography •\n')
        title.config(font=('Arial',30), fg="#52424D")
        title.grid(pady=10)

        b_encode = Button(f,text="Encode",command= lambda :self.frame1_encode(f), padx=14, bg ="pink", fg="#52424D")
        b_encode.config(font=('Arial',14))
        b_decode = Button(f, text="Decode",padx=14,command=lambda :self.frame1_decode(f), bg ="pink", fg="#52424D")
        b_decode.config(font=('Arial',14))
        ...
        # ascii_art.config(font=('MingLiU-ExtB',50))
        ascii_art2.config(font=('Arial',1,'bold'))
    ...
    def frame1_encode(self,f):
        ...
        back_button.config(font=('Arial',16), bg="#52424D", fg="pink", padx=18)
        back_button.grid(pady=15)
        back_button.grid()
        f2.grid()
    ...
    def frame2_encode(self,f2):
        ...
        if not myfile:
            ...
            l3.config(font=('Arial',15), fg="#52424D")
            l3.grid()
